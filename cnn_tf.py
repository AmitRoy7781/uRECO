...
def get_num_of_classes():
	return len(os.listdir('/home/amit-roy/PycharmProjects/uRECO/ASL/gestures/'))
...
def main(argv):
	with open("/home/amit-roy/PycharmProjects/uRECO/ASL/train_images", "rb") as f:
		train_images = np.array(pickle.load(f))
	with open("/home/amit-roy/PycharmProjects/uRECO/ASL/train_labels", "rb") as f:
		train_labels = np.array(pickle.load(f), dtype=np.int32)

	with open("/home/amit-roy/PycharmProjects/uRECO/ASL/test_images", "rb") as f:
		test_images = np.array(pickle.load(f))
	with open("/home/amit-roy/PycharmProjects/uRECO/ASL/test_labels", "rb") as f:
		test_labels = np.array(pickle.load(f), dtype=np.int32)
	#print(len(train_images[1]), len(train_labels))

	classifier = tf.estimator.Estimator(model_fn=cnn_model_fn, model_dir="/home/amit-roy/PycharmProjects/uRECO/ASL/tmp/cnn_model3")
